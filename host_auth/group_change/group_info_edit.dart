// ignore_for_file: use_super_parameters, library_private_types_in_public_api, sized_box_for_whitespace, prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_print
...
class _GroupDetailsPageState extends State<GroupInfoPage> {
  ...
  @override
  void didUpdateWidget(GroupInfoPage oldWidget) {
  ...
  void _deleteGroupPage() {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Διαγραφή Group'),
          content: Text(
            'Είστε σίγουρος ότι θέλετε να διαγράψετε το γκρουπ;\nΠροσοχή!! Αυτή η ενέργεια θα αφαιρέσει το γκρουπ, θα διαγραφούν όλες οι πληροφορίες και οι φωτογραφίες του.',
          ),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context)
                    .pop(); // Κλείνει το AlertDialog χωρίς να κάνει κάτι άλλο
              },
              child: Text(
                'Όχι',
              ...
              onPressed: () {
                FirebaseFirestore.instance
                  ...
                  firebase_storage.FirebaseStorage.instance
                      .ref()
                      .child('costumes/${formatDocumentID(widget.documentID)}')
                      .listAll()
                      .then((result) {
                    for (var item in result.items) {
                      item.delete().then((_) {
                        print('Το αρχείο ${item.name} διαγράφηκε με επιτυχία.');
                      }).catchError((error) {
                        print(
                            'Σφάλμα κατά τη διαγραφή του αρχείου ${item.name}: $error');
                      });
                    }
                  }).then((_) {
                    firebase_storage.FirebaseStorage.instance
                        ...
                        .delete()
                        .then((_) {
                      print('Ο φάκελος διαγράφηκε με επιτυχία.');
                    }).catchError((error) {
                      print('Σφάλμα κατά τη διαγραφή του φακέλου: $error');
                    });

                    // Διαγραφή από τους καταλόγους sunday_parade και saturday_parade
                    FirebaseFirestore.instance
                        .collection('sunday_parade')
                        .doc(formatDocumentID(widget.documentID))
                        .delete()
                        .catchError((error) {
                      print('Σφάλμα κατά τη διαγραφή από το sunday_parade: $error');
                    });
                    ...
                    FirebaseFirestore.instance
                        ...
                        .delete()
                        .catchError((error) {
                      print('Σφάλμα κατά τη διαγραφή από το saturday_parade: $error');
                    });

                    Navigator.of(context).pop(); // Κλείνει το AlertDialog
                    ...
                    print('Σφάλμα κατά τη λίστα των αρχείων: $error');
                  });
                }).catchError((error) {
                  print('Σφάλμα κατά τη διαγραφή του group: $error');
                });
              },
              child: Text(
                'Διαγραφή',
