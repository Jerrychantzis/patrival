// ignore_for_file: prefer_const_constructors, use_super_parameters, avoid_print, deprecated_member_use, unused_element
...
import 'package:carnival_app1/features/user_auth/presentation/widgets/custom_app_bar.dart';
import 'package:carnival_app1/features/user_auth/presentation/pages/home_menu/profile.dart';

import '../user_auth/presentation/pages/home_menu/estimated_times.dart';
import 'captain_group_list.dart';
import 'captain_notifications.dart';
...
class _CaptainHomePageState extends State<CaptainHomePage> {
  ...
  final List<Color> _backgroundColors = [
    ...
    Colors.lightGreen,        // Χρώμα για Estimated Start Times
    Colors.yellow, // Χρώμα για Home
    Colors.purpleAccent,       // Χρώμα για Live Broadcast
